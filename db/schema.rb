...
ActiveRecord::Schema[7.0].define(version: 20_230_214_215_312) do
  ...
  create_table 'inventories', force: :cascade do |t|
    ...
    t.index %w[store_id product_id], name: 'index_inventories_on_store_id_and_product_id', unique: true
